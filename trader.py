...
class Trader:
    ...
    def _make_strategy_safe(self):
        ...
        if self.strategy.loop_order_type == 'stop_limit':
            ...
            self.strategy.loop_buy_limit_price = self.strategy.loop_buy_stop_price + loop_trade_spread
            self.strategy.loop_sell_limit_price = self.strategy.loop_buy_stop_price - loop_trade_spread
            ...
            self.strategy.jump_buy_limit_price = self.strategy.jump_buy_stop_price + jump_trade_spread
            self.strategy.jump_sell_limit_price = self.strategy.jump_buy_stop_price - jump_trade_spread
